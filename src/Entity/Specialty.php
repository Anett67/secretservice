 ...
 * @UniqueEntity("name", message="Un spécialité avec ce nom existe déjà")
 */
class Specialty
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Mission::class, mappedBy="specialty")
     */
    private $missions;
